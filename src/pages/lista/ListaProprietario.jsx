  ...
  return (
    ...
    <div className="col-12">
      ...
      <div className="d-flex bd-highlight mb-3">
        <Link to="/CadastroProprietario" className="btn btn-dark me-auto p-2 bd-highlight">Adicionar</Link>
        <span class="p-2 material-symbols-outlined me-2"><FontAwesomeIcon icon={faMagnifyingGlass} size='xl' /></span>
        <FormControl
          type="text"
